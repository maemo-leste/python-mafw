...
#define MAFW_TYPE_ERROR (mafw_error_get_type())

GType mafw_extension_error_get_type (void) G_GNUC_CONST;
#define MAFW_TYPE_EXTENSION_ERROR (mafw_extension_error_get_type())

GType mafw_playlist_error_get_type (void) G_GNUC_CONST;
#define MAFW_TYPE_PLAYLIST_ERROR (mafw_playlist_error_get_type())

GType mafw_renderer_error_get_type (void) G_GNUC_CONST;
#define MAFW_TYPE_RENDERER_ERROR (mafw_renderer_error_get_type())
